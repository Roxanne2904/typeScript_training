...
type SortBy = Sort.AGE | Sort.NAME | Sort.SCORE;
...
function sortBy(
	...
	const sortedArray = array.sort((a: People, b: People): number =>
...
function sort(array: People[]): People[] {
	return array.sort((a: People, b: People): number | 0 => {
